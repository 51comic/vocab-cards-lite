...
从 JSON 单词数据生成黑白打印优化的专业英语闪卡 PNG。**主卡 + 副卡 + 百度百科二维码**三件套，功能与完整版完全一致，区别仅在于**内置的是裁剪后的精简中文字体，包体约 5MB**（完整版为 40MB）。
...
> 精简字体覆盖 **GB2312 一级常用汉字 + 常用标点 + 全部 IPA 音标字符**，足以满足中学/大学/四六级/雅思等常见词汇闪卡需求。
...
- **段级字体选择**：IPA 音标 → DejaVu，中文/CJK → 精简 NotoSansCJK(face index 2)
...
- 精简字体仅覆盖常用汉字；若遇生僻字显示方框，请改用完整版 `vocab-cards-pro`
